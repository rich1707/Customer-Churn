...
churn %>% 
   ...
   geom_point(size = 3, colour = "#CB9E23") +
...
churn %>% 
   ...
   geom_point(size = 3, alpha = 0.25, colour = "#CB9E23") + 
...
plot_payment <- churn %>% 
   ...
   geom_bar(position = "dodge", colour = "black", width = 0.65, alpha = 0.5) + 
...
(plot_billing + plot_contract) / plot_payment +
   plot_layout(guides = "collect")
...
plot_contract_tech <- churn %>% 
   ...
   ggplot(aes(x = contract, fill = churn_label)) + 
   geom_bar(position = "dodge", colour = "black", width = 0.625, alpha = 0.5) +
